...
public class NutritionixProxyTest
{
	...
	public static void beforeClass() 
	{
		...
		NutritionixClientBuilder builder = NutritionixClientBuilder.builder()
				.setBaseUrl("http://127.0.0.1:8089/v1_1")
				.setAppId(System.getenv("APPID")==null?"mock":System.getenv("APPID"))
				.setAppKey(System.getenv("APPKEY")==null?"mock":System.getenv("APPKEY"));
	...
	public static void initializeMockUrls() throws JsonProcessingException
	{
		...
		stubFor(get(urlMatching("/v1_1/item.*"))
		...
		stubFor(get(urlMatching("/v1_1/brand/.*"))
		            .willReturn(aResponse()
		                .withStatus(200)
		                .withHeader("Content-Type", "application/json")
		...
		stubFor(get(urlMatching("/v1_1/search/.*"))
		            .willReturn(aResponse()
		                .withStatus(200)
		                .withHeader("Content-Type", "application/json")
